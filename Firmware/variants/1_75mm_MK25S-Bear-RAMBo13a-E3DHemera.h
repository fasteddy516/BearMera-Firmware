...
#define NOZZLE_TYPE "E3DHemera" // bear hemera (prusa default = "E3Dv6full")

// Developer flag
#define DEVELOPER

// Printer name
#define CUSTOM_MENDEL_NAME "BearMera MK2.5S" // bear hemera (prusa default = "Prusa i3 MK2.5S")
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,3200/8,409} // bear hemera (prusa default = {100,100,3200/8,133})
...
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {540, 830, 1150} // bear hemera {XY,Z,E} 
#define Z_SILENT 0
...
#define X_PROBE_OFFSET_FROM_EXTRUDER 35.75 // bear hemera, -left +right (prusa default = 23) 
#define Y_PROBE_OFFSET_FROM_EXTRUDER 18.7 // bear hemera, -front +behind (prusa default = 5)
